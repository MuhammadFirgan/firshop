...
const Navbar = ({type}: BarTypeProps) => {
  ...
  return (
    <>
      {type === "dashboard" ? (
        <header className="fixed top-0 left-0 md:left-64 right-0 h-16 bg-white/70 backdrop-blur-sm border-b border-white/20 px-6 items-center justify-between md:z-10 flex">
          ...
          <div className="flex items-center space-x-4">
            <Button className="relative p-2 text-slate-600 hover:text-blue-600 hover:bg-blue-50/50 rounded-xl transition-all duration-200 bg-blue-50">
              <Bell className="w-5 h-5" />
              <span className="absolute -top-1 -right-1 w-3 h-3 bg-red-500 rounded-full"></span>
            </Button>
            
            <Button className="p-2 text-slate-600 hover:text-blue-600 hover:bg-blue-50/50 rounded-xl transition-all duration-200 bg-blue-50">
